# P2C
## IMPORTANT THINGS BELOW | NHỮNG ĐIỀU QUAN TRỌNG CẦN LƯU Ý BÊN DƯỚI
## 以下为重要内容
...
## Các chương trình được tạo ra bởi trình biên dịch này không bị ràng buộc bởi
## Giấy phép Công cộng GNU GPL; người dùng được phép phân phối và cấp phép
## các chương trình đó theo bất kỳ điều khoản nào.

## 由本编译器生成的输出不受 GNU 通用公共许可证（GPL）的约束，
## 用户可以按照任何条款为其生成的程序选择许可证。
<div align="center">
